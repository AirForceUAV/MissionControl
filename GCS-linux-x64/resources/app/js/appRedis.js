...
$(".guide_fly").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.Guided()");
    showTips("Guided模式!");
});
$(".avoid_fly").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"lidar.Guided_Avoid()");
    showTips("避障模式!");
});
$(".radio_d").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.radio()");
    showTips("遥控器模式!");
});
$(".gcs").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.GCS()");
    showTips("地面站模式!");
});
$(".hovering").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.set_channels_mid()");
    showTips("悬停设置!");
});
$(".back-home").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.RTL()");
    showTips("返航!");
});
$(".download_path").on("click", function () {
    hideWin();
    openDowload = true;
    client.lpush(ClientSendChan,"vehicle.download()");
    showTips("下载路径!");
});
$(".auto_path").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.AUTO()");
    showTips("AUTO!");
});
var route_mes;
...
$(".take-off").on("click", function (){
    ...
    client.lpush(ClientSendChan,route_mes);
...
$(".dn_de_submit").on("click", function () {
    ...
    client.lpush(ClientSendChan,mes);
...
$(".l-button").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.set_gear(1)");
    showTips("低挡位!");
});
$(".m-button").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.set_gear(2)");
    showTips("中档位!");
});
$(".h-button").on("click", function () {
    hideWin();
    client.lpush(ClientSendChan,"vehicle.set_gear(3)");
    showTips("高档位!");
});
$(".brake").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.brake()");
    showTips("刹车!");
});
$(".turn-up").on("click", function () {
    client.lpush(ClientSendChan,ClientSendChan,"vehicle.up_brake()");
    showTips("向上！");
});
$(".turn-down").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.down_brake()");
    showTips("向下！");
});
$(".turn-left").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.yaw_left_brake()");
    showTips("向左！");
});
$(".turn-right").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.yaw_right_brake()");
    showTips("向右！");
}); 

$(".roll-up").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.forward_brake()");
    showTips("Roll up");
});
$(".roll-down").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.backward_brake()");
    showTips("Roll down");
});
$(".roll-left").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.roll_left_brake()");
    showTips("Roll left");
});
$(".roll-right").on("click", function () {
    client.lpush(ClientSendChan,"vehicle.roll_right_brake()");
    showTips("Roll right");
}); 
$(".cancel").on("click", function () {
    ...
    var slider = new SliderUnlock(".slideunlock-slider", {
        ...
        client.lpush(ClientSendChan,"Cancel");
        showTips("取消！");
        slider.reset();
    }, function(){
    });
